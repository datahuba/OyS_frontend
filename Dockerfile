# Etapa 1: Construcción del build estático de React con Vite
...
# Ejecuta vite build, el cual compila en la carpeta '/app/dist'
RUN npm run build

# Etapa 2: Servir con Nginx Alpine de producción
FROM nginx:1.25-alpine
# Copiamos de la carpeta 'dist' generada por Vite
